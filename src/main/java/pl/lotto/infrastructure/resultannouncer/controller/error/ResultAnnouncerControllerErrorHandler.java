...
public class ResultAnnouncerControllerErrorHandler {
    ...
    public RessultAnnouncerErrorResponse handlePlayerResultNotFound(PlayerResultNotFoundException exception){
        String message = exception.getMessage();
        log.error(message);
        return new RessultAnnouncerErrorResponse(message, HttpStatus.NOT_FOUND);
    }
}
